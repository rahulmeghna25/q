...
bot = telebot.TeleBot('7775849416:AAGwq5pW6RPqJZTcWbVF91B285u31BSiW1U')
    ...
    def run_attack():
        ...
        try:
            ...
            with attack_lock:
                attack_active = False
                current_attacker = None
            bot.send_message(message.chat.id, f"✅ **BGMI Attack Finished!**\n🎯 Target: `{target}:{port}`", parse_mode="Markdown")
